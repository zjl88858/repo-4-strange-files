...
echo/
echo/
echo Server:Bidoof 你正通过服务器:Bidoof连接互联网
setproxy.exe on 127.0.0.1 1080
daze.exe client -s "104.168.147.129:8080" -l "0.0.0.0:1080" -k "daze@3591342552908659" -e "asheshadow" -f "auto" -dns "1.2.4.8:53"
exit